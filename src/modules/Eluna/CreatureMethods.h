...
namespace LuaCreature
{
    ...
    {
#if defined(TRINITY) || defined(AZEROTHCORE) || defined(CMANGOS) || defined(VMANGOS)
...
#elif defined(MANGOS) || defined VMANGOS
        ThreatList const& threatlist = creature->GetThreatManager().getThreatList();
#elif defined(TRINITY)
...
#elif VMANGOS
        creature->UpdateEntry(entry, NULL, dataGuidLow ? eObjectMgr->GetCreatureData(dataGuidLow) : NULL);
#else
